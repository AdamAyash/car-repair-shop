...
GROUP BY CLIENTS.NAME, CLIENTS.IDENTITY_NUMBER, CARS.REGISTRATION_NUMBER,BRANDS.NAME,BEGIN_DATE,END_DATE
ORDER BY BRANDS.NAME, CARS.REGISTRATION_NUMBER ASC
